...
import { Eye, ArrowRight, MessageSquareCheck, ShoppingBag } from 'lucide-react';
      ...
      <div className="p-5 flex flex-col flex-grow justify-between">
        <div>
          <div className="flex justify-between items-start gap-4 mb-4">
            <h3 className="font-heading font-bold text-base text-slate-900 group-hover:text-secondary transition-colors duration-200 line-clamp-2 leading-snug text-left">
          ...
          <button
            ...
            className="w-full mb-3 border border-slate-200 hover:border-slate-800 text-slate-800 hover:text-white hover:bg-slate-800 font-heading font-bold text-xs py-2.5 px-4 rounded-xl transition-all flex items-center justify-center gap-2"
          >
